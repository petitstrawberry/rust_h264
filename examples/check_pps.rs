...
fn main() {
    ...
    println!("  bottom_field_pic_order_in_frame_present_flag: {}", pps.bottom_field_pic_order_in_frame_present_flag);
    ...
    println!("  deblocking_filter_control_present_flag: {}", pps.deblocking_filter_control_present_flag);
    println!("  constrained_intra_pred_flag: {}", pps.constrained_intra_pred_flag);
    println!("  redundant_pic_cnt_present_flag: {}", pps.redundant_pic_cnt_present_flag);
