        ...
        while mb_idx < total_mbs {
            ...
            if use_cabac {
                        ...
                        if is_p_slice {
                            ...
                            for blk in 0..16 {
                                ...
                                if bp0 && bp1 {
                                    ...
                                    let mut p1 = [0u8; 16];
                                    inter_pred::luma_mc(
                                        ref_pic_safe(&_ref_pic_list_l0, r0),
                                        bx as i32,
                                        by as i32,
                                        mv0[0] as i32,
                                        mv0[1] as i32,
                                    ...
                                    inter_pred::luma_mc(
                                        ref_pic_safe(&_ref_pic_list_l1, r1),
                                        bx as i32,
                                        by as i32,
                                        mv1[0] as i32,
                                        mv1[1] as i32,
                            ...
                            for plane_idx in 0..2 {
                                ...
                                for cblk in 0..4 {
                                    ...
                                    if bp0 && bp1 {
                                        ...
                                        let cr0 =
                                            if plane_idx == 0 { &ref_l0.u } else { &ref_l0.v };
                                        let cr1 =
                                            if plane_idx == 0 { &ref_l1.u } else { &ref_l1.v };
                                        inter_pred::chroma_mc(
                                            cr0,
                                            cw,
                                            chroma_h,
                                    ...
                                    for r in 0..4 {
                                        for c in 0..4 {
                                            chroma_pred[(cblk_row + r) * 8 + cblk_col + c] =
                                                cblk_pred[r * 4 + c];
                                        }
                                    }
                                }
                    ...
                    if raw_mb_type >= intra_limit {
                        ...
                        if i_mb_type == 0 {
                            ...
                            for blk_idx in 0..num_modes {
                                ...
                                let predicted =
                                    predict_i4x4_mode(&i4x4_modes, mb_idx, mb_width as usize, blk, &mb_slice_id, this_slice_id);
                ...
                let above_mb_avail_i = mb_idx >= mb_width as usize
                    && mb_slice_id[mb_idx - mb_width as usize] == this_slice_id;
                let left_mb_avail_i = mb_idx % mb_width as usize != 0
                    && mb_slice_id[mb_idx - 1] == this_slice_id;
            ...
            if mb_type == 0 {
                ...
                for blk_idx in 0..num_modes {
                    ...
                    let predicted = predict_i4x4_mode(&i4x4_modes, mb_idx, mb_width as usize, blk, &mb_slice_id, this_slice_id);
...
fn predict_i4x4_mode(
    ...
    let mode_a =
        get_neighbor_i4x4_mode(modes, mb_idx, mb_width, blk_idx, true, mb_slice_id, cur_slice_id);
